...
const SectionHeading = ({ children, align = "center" }: { children: React.ReactNode; align?: "left" | "center" }) => (
  <h2
    className={`text-3xl md:text-5xl font-bold mb-6 tracking-tight ${align === "center" ? "text-center" : "text-left"}`}
  >
    {children}
  </h2>
);
...
const SectionSubheading = ({
  ...
  <p
    className={`text-zinc-400 max-w-2xl text-lg leading-relaxed ${align === "center" ? "mx-auto text-center" : "text-left"}`}
  >
    {children}
  </p>
);
...
const FAQItem = ({ question, answer }: { question: string; answer: string }) => {
  ...
  return (
    <div className="border-b border-white/10 last:border-0">
      ...
      >
        <p className="text-zinc-400 leading-relaxed pr-6">{answer}</p>
      </div>
    </div>
  );
};
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 md:gap-20 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            ...
            <span className="text-xl font-bold font-mono text-white">
              BLOCK<span className="text-indigo-500">CHAIN</span>
            </span>
            <span className="text-xl font-bold font-serif italic text-white">
              Creator<span className="text-zinc-600">DAO</span>
            </span>
            <span className="text-2xl font-black tracking-tighter text-white">
              STREAM<span className="text-purple-500">LABS</span>
            </span>
            <span className="text-xl font-bold text-white flex items-center gap-1">
              <div className="w-6 h-6 bg-white rounded-full"></div>Pixel
            </span>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <SectionSubheading align="left">
                See global tipping activity as it happens. Our settlement engine processes transactions instantly,
                ensuring creators get paid the moment a fan hits &quot;send&quot;.
              </SectionSubheading>
            ...
            <div className="md:col-span-2 bg-[#0F0F10] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-zinc-400 max-w-sm">
                  We subsidize all gas fees for your donors using Account Abstraction. They pay exactly what they want
                  to tip, and you receive every cent.
                </p>
              </div>
            </div>
            ...
            <div className="md:row-span-2 bg-[#0F0F10] border border-white/5 rounded-3xl p-8 hover:border-white/10 transition-colors relative overflow-hidden group">
              ...
              <div className="relative z-10 h-full flex flex-col">
                ...
                <p className="text-zinc-400 mb-6 font-light leading-relaxed">
                  Your funds never touch our servers. Smart contracts handle everything, sending crypto directly to your
                  wallet.
                </p>
