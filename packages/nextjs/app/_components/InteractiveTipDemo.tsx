...
import { BoltIcon, CurrencyDollarIcon, ShieldCheckIcon, UserCircleIcon } from "@heroicons/react/24/outline";
...
export const InteractiveTipDemo = () => {
  ...
  return (
    <div className="relative group w-full max-w-sm mx-auto">
      <div className="relative bg-white dark:bg-slate-950 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 md:p-8 shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between mb-8 md:mb-12">
          ...
          <div className="flex items-center gap-2 px-3 py-1 bg-[#14B8A6]/10 rounded-full border border-[#14B8A6]/30">
            <ShieldCheckIcon className="w-3 h-3 text-[#14B8A6]" />
            <span className="text-[10px] font-bold text-[#14B8A6] uppercase tracking-wide">Gasless</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mb-8 md:mb-10">
          ...
          <p className="mt-2 text-sm font-medium text-gray-400 dark:text-gray-500 uppercase tracking-widest text-[10px]">
            USD Coin
          </p>
        </div>
        ...
        <div className="mb-10 px-1">
          <input
            ...
            className="w-full h-1.5 bg-gray-100 dark:bg-gray-800 rounded-lg appearance-none cursor-pointer accent-[#14B8A6] transition-all"
          />
        ...
        <AnimatePresence>
          {isTipping && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              className="absolute inset-0 bg-white dark:bg-slate-950 z-20 flex flex-col items-center justify-center"
            >
              <motion.div
