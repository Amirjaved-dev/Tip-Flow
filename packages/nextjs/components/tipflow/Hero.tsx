...
export const Hero = ({ openConnectModal }: { openConnectModal?: () => void }) => {
  return (
    <section className="relative pt-24 pb-20 md:pt-36 md:pb-32 overflow-hidden min-h-[90vh] flex items-center">
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-start text-left stagger-container">
            {/* Pill Label */}
            <div className="slide-up inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0068FF]/10 border border-[#0068FF]/30 mb-8 hover:bg-[#0068FF]/20 transition-all cursor-default shadow-[0_0_20px_-5px_rgba(0,104,255,0.2)]">
              <SparklesIcon className="w-4 h-4 text-[#0068FF]" />
              <span className="text-sm font-semibold text-[#0068FF]/90">The Future of Micro-Payments</span>
            </div>
            ...
            <h1 className="slide-up text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight mb-8 leading-[1.2] text-white">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#0068FF] via-white to-[#00A896]">
                Your Influence
              </span>
            </h1>
            ...
            <p className="slide-up text-xl md:text-2xl text-zinc-300 mb-10 max-w-xl leading-relaxed font-light">
              Accept crypto tips instantly. Low fees. No delays. Just pure, gasless value transfer secured on-chain.
            </p>
          ...
          <div className="relative fade-in delay-500 hidden md:block">
            {/* Glow Effect */}
            <div className="absolute inset-0 bg-gradient-to-tr from-[#0068FF]/30 to-[#00A896]/30 rounded-full blur-[100px] -z-10 transform scale-75"></div>

            <div className="relative transform rotate-2 hover:rotate-0 transition-transform duration-500 ease-out lift-hover">
              <div className="absolute inset-0 bg-gradient-to-r from-[#0068FF] to-[#00A896] rounded-2xl blur-lg opacity-20"></div>
              ...
              <div className="absolute -top-10 -right-10 bg-zinc-900/80 border border-white/10 p-4 rounded-2xl shadow-2xl backdrop-blur-md animate-bounce duration-[3000ms] lift-hover">
                <div className="w-10 h-10 bg-[#0068FF]/20 rounded-full flex items-center justify-center">
                  <RocketLaunchIcon className="w-6 h-6 text-[#0068FF]" />
                </div>
              </div>
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#0068FF]/10 rounded-full blur-[130px] -z-10 pointer-events-none translate-x-1/2 -translate-y-1/2" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-[#00A896]/5 rounded-full blur-[100px] -z-10 pointer-events-none -translate-x-1/3 translate-y-1/3" />
    </section>
  );
};
